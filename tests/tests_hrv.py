...
def test_hrv():
    ...
    columns = [
        ...
        "HRV_DFA_alpha1_ExpMean",
        "HRV_DFA_alpha1_DimRange",
        "HRV_DFA_alpha1_DimMean",
        "HRV_DFA_alpha2",
        "HRV_DFA_alpha2_ExpRange",
        "HRV_DFA_alpha2_ExpMean",
        "HRV_DFA_alpha2_DimRange",
        "HRV_DFA_alpha2_DimMean",
    ]

    assert all(elem in np.array(ecg_hrv.columns.values, dtype=object) for elem in columns)
