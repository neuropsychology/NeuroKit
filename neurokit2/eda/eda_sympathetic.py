...
def eda_sympathetic(
    ...
    dict
        ...
        .. codebookadd::
            EDA_Sympathetic|Electrodermal activity|Derived from Posada-Quintero et al. (2016), who argue that dynamics of the sympathetic component of EDA signal is represented in the frequency band of 0.045-0.25Hz.
            EDA_SympatheticN|Electrodermal activity|normalized version of "EDA_Sympathetic" obtained by dividing EDA_Sympathetic by total power
