...
def signal_binarize(signal, method="threshold", threshold="auto"):
    ...
    threshold : float
        If `method` is 'mixture', then it corresponds to the minimum probability required to be
        considered as activated (if 'auto', then 0.5). If `method` is 'threshold', then it
