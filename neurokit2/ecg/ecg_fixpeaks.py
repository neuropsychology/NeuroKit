...
def ecg_fixpeaks(rpeaks, sampling_rate=1000, show=False):
    ...
    Identify erroneous inter-beat-intervals. Based on Jukka A. Lipponen & Mika
    P. Tarvainen (2019): A robust algorithm for heart rate variability time
    series artefact correction using novel beat classification, Journal of
    Medical Engineering & Technology, DOI: 10.1080/03091902.2019.1640306
