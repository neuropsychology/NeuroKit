...
def ecg_eventrelated(epochs, silent=False, rate_start=None, rate_end=None):
    ...
    for i in epochs.keys():
        ...
        # Rate
        data[i] = _eventrelated_rate(epochs[i], data[i], var="ECG_Rate", rate_start=rate_start, rate_end=rate_end)
