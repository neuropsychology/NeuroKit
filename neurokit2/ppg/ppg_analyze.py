...
def ppg_analyze(data, sampling_rate=1000, method="auto"):
    """Performs PPG analysis on either epochs (event-related analysis) or on longer periods of data such as resting-
    state data.
    ...
    data : Union[dict, pd.DataFrame]
        ...
        DataFrame of processed signals from a longer period of data, typically generated by `ppg_process()`
    ...
    DataFrame
        ...
        by the `Label` column. See `ppg_eventrelated()` and
        `ppg_intervalrelated()` docstrings for details.
