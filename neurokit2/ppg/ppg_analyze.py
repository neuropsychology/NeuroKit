...
def ppg_analyze(data, sampling_rate=1000, method="auto"):
    ...
    data : Union[dict, pd.DataFrame]
        ...
        :func:`.epochs_to_df`. Can also take a DataFrame of processed signals from a longer period of data, typically generated by :func:`.ppg_process` or :func:`.bio_process`. Can also
