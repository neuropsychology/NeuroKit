...
def entropy_differential(signal, **kwargs):
    ...
    Differential entropy (DiffEn; also referred to as continuous entropy) started as a (failed) attempt by Shannon to extend Shannon entropy (https://en.wikipedia.org/wiki/Differential_entropy).
    ...
    **kwargs : optional
    ...
    References
    -----------
    - `scipy.stats.differential_entropy()` <https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.differential_entropy.html>`_
