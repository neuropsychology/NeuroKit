...
*NeuroKit2* aims at being reliable and trustworthy, including processing pipelines that have been described in peer-reviewed literature and functions that have been tested against established software such as *BioSPPy* [@biosppy], *hrv* [*under review*](https://github.com/openjournals/joss-reviews/issues/1867), *PySiology* [@PySiology], *HeartPy* [@HeartPy], *systole* [@Systole] or *nolds* [@nolds]. Unittest-based tests are implemented through *pytest* which provides comprehensive reports of test results, making code failures easibly traceable. Brief examples are also documented through docstrings that simultaneously function as *doctests*. As of 25 August 2020, *NeuroKit2* has a code coverage of 83.3% and its build status can be tracked via its GitHub repository. Overall, the repository leverages a comprehensive test suite and continuous integration (CI) through the Travis-CI platform to ensure stability and prevent errors. Thanks to its collaborative and open development, *NeuroKit2* can remain cutting-edge and continuously evolve, adapt, and integrate new methods as they are emerging.
