...
<!-- Response to gap -->
*NeuroKit2* addresses these challenges by offering a free, user-friendly, and comprehensive solution for neurophysiological data processing, with an initial focus on bodily signals including electrocardiogram (ECG; measures the electrical activity of one's heart), photoplethysmogram (PPG; optical measurement of the rate of blood flow due to the heart's pumping action), respiration (RSP; measures rate and volume of breaths taken), electrodermal activity (EDA; measures electrical conductance of the skin due to sweat secretion), electromyography (EMG; measures electrical activity produced by skeletal muscles as a result of muscle contractions) and electrooculography . It also comprises of generic functions that could also support other signal processing such as electroencephalography (EEG; measures electrical activity of the brain via electrodes on the scalp), for which more specific support is in development.
