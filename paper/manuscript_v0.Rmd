...
Signals are 2.5 minutes long and are recorded at a frequency of 100Hz [note that the sampling rate is low for storage purposes and should be higher in actual recordings, see @Quintana2016]. It has 4 channels including three physiological signals, and another corresponding to the marking of events via a photosensor (which signal decreased when a stimulus was displayed on the screen).
