...
affiliation:
  ...
  - id            : "3"
    institution   : "???"
  - id            : "4"
    institution   : "Département de Psychologie, Université de Montréal, Montréal, Québec, Canada"
  - id            : "5"
    institution   : "???"
  - id            : "6"
...
<!-- Research gap -->
The field of cognitive neuroscience and psychology is increasingly relying on neurophysiological methods. One of the reason is that such approaches often offer low monetary cost (especially compared with other imaging techniques, such as MRI) and high user convenience (e.g., portability). At the same time, the fields of signal processing and computational data science are strongly growing, tackling issues and limitations, and pushing the horizon of possibilities and opportunities. However, as these methods are often not easily accessible and user-friendly, neurophysiological data processing remains a challenge for many researchers without a formal programming training.
