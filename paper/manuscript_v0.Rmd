...
This dataset contains three channels (ECG, PPG and RSP) recorded at a frequency of 100Hz during five minutes of a human at rest (eyes-closed in a sitted position). In this example, one would be interested in extracting features of rate variability and longer-term activations.
