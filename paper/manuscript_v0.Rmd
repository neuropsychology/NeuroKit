...
<!-- Research gap -->
Cognitive neuropsychology <!--Cognitive neuroscience and psychology--> is increasingly relying on neurophysiological <!--methods--> approaches to assess brain and bodily activity. These approaches include, but are not limited to the recording of electroencephalogram (EEG), electrocardiogram (ECG) and electrodermal activity (EDA) signals. This trend was driven not only by theoretical motivations (e.g., the growth of embodied or affective neuroscience, @Kiverstein2015)<!--considerations motivating-->, but also by practical reasons including low monetary cost (especially compared with other imaging techniques, such as MRI or MEG) <!--high--> and user convenience (e.g., portability, setup speed) where such recording devices (e.g., smart watches, @yuehong2016internet) are widely available. Together with the growth of neurophysiological recording techniques, the advancement of signal processing techniques and computational data science has propagated the emergence of new processing algorithms [@clifton2012machine; @roy2019deep], which in turn offer a myriad of novel methods for users to process and analyze neurophysiological signals. 

However, as the implementations of these methods in existing software packages are often <!--easily accessible--> abstruse, neurophysiological data processing remains a challenge for many researchers without a formal training or experience in programming. Moreover, many existing implementations are also limited to one type of signals (e.g., pyHRV for heart rate variability, cvxEDA for EDA). This makes it inconvenient for researchers who might have to concurrently rely on different softwares to process multiple signals.

<!--At the same time, the fields of signal processing and computational data science continue to grow, pushing the horizon of possibilities and resulting in the emergence of a mryiad of new processing algorithms [@clifton2012machine; @roy2019deep].--> 
