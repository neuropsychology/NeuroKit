...
intervalrelated <- c("ECG Rate Mean", "HRV metrices", "RRV metrices", "RSA metrices", "Number of SCR Peaks", "Mean of SCR Peaks Amplitude")

eventrelated <- c("ECG Rate Measures (Min, Mean, Max, Time of occurrences) and Trend (Linear, Quadratic, R2)", "RSP Rate Measures (Min, Mean, Max, Time of occurrences)", "RSP Amplitude Measures (Min, Mean, Max)", "ECG and RSP Phase Measures", "EDA Phasic Max Peak Amplitude", "Number of SCRs and first SCR Measures (Peak Amplitude, Risetime, Recovery time)")
