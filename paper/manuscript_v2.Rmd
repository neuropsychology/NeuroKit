...
<!-- Response to gap -->
*NeuroKit2* addresses these challenges by offering a free, user-friendly, and comprehensive solution for neurophysiological data processing. It is an open-source Python package, developed by a multi-disciplinary team that actively invites new collaborators. It aims at being accessible, well-documented, well-tested, cutting-edge, flexible and efficient. Historically, *NeuroKit2* is the re-forged successor *NeuroKit1*, taking on its most successful features and design choices, and re-implementing them in a professional and well-thought way.
