...
html_theme_options = {"collapse_navigation": False}  # Expandables entries
...
latex_documents = [
    (master_doc, "neurokit2.tex", pdf_title, author_field, "manual"),
]
...
man_pages = [(master_doc, "neurokit2", pdf_title, [author_field], 1)]
