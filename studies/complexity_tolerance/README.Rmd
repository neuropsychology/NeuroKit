...
In order to approximate $r_{maxApEn}$, the best two methods were cut-offs points of recurrence rate *RR* and of the number of nearest neighbours *NN*. However, these two methods are very computationally expensive (*RR* even surpassing max. ApEn), casting doubt on their practical usefulness.
