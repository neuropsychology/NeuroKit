...
df |> 
  ...
  geom_hline(yintercept = 10**seq(0, 5, by=2), linetype = "dotted") +
  geom_hline(yintercept = 10**seq(1, 5, by=2), linetype = "plain") +
...
# rez <- parameters::principal_components(data, n = 8, sort = TRUE)
rez
