...
Complexity indices, despite their multitude, their unicities and specificities, do indeed share similarities. They form clusters (some indices, by design, index the "predictability", whereas other the "randomness", and thus are negatively related to one-another).
...
Indices that were highlighted as encapsulating information about different underlying dimensions a ta low computational cost include... 
