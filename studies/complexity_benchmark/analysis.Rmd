...
p
# ggsave("fig/computation_time-1.png", p, height=10*1.25, width=16*1.25)
```
...
```{r ggm, message=FALSE, warning=FALSE, fig.width=13, fig.height=13, fig.cap="Correlation network of the complexity indices. Only the links where |r| > 0.6 are displayed."}
library(ggraph)
...
```{r clustering, message=FALSE, warning=FALSE, fig.width=13.4, fig.height=13.4, fig.cap = "Dendrogram representing the hierarchical clustering of the complexity indices."}
clust <- data |>
...
```{r message=FALSE, warning=FALSE, fig.width=14, fig.height=7, fig.cap="Visualization of the expected value of a selection of indices depending on the signal type and of the amount of noise."}
