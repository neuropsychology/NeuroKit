...
Fortunately, it is possible to decrease the smoothness by increasing the number of degrees of freedom of the smooth term. We will set the dimension *k* to 5\% to the length of the epochs, which in our case corresponds to `0.05 * 600 ms`.
